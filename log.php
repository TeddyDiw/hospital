<?php 
    ...
    $sql = "INSERT INTO user (sugender, suname, suage, subloodgroup, sumedicalrights, sunumber, sumobilenumber, suintro) VALUES ('$type', '$fullname', '$age', '$bg', '$mr', '$number', '$mnb','$intro')";
